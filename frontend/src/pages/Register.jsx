  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center py-12 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        >
          <source src='https://res.cloudinary.com/drariarqq/video/upload/v1773571226/register-background_da8ash.mp4' type="video/mp4" />
      ...
      {/* Decorative Elements - Updated with lighter colors for better visibility on video */}
      <div className="absolute top-10 left-10 w-20 h-20 bg-blue-300/30 rounded-full mix-blend-overlay filter blur-xl opacity-70 animate-blob"></div>
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-purple-300/30 rounded-full mix-blend-overlay filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/3 right-1/4 w-24 h-24 bg-pink-300/30 rounded-full mix-blend-overlay filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>

      <div className="relative z-10 max-w-4xl w-full">
        {/* Header - Updated with better contrast */}
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl mb-6 shadow-xl shadow-blue-500/30">
        ...
        {/* Registration Type Selector - Made more visible */}
        <div className="flex justify-center mb-8">
          <div className="bg-white/20 backdrop-blur-md rounded-2xl p-2 flex gap-2 border border-white/30 shadow-2xl">
            <button
              type="button"
        ...
        {/* Artisan Benefits Card - Updated with better contrast */}
        {registrationType === "artisan" && (
          <div className="mb-8 p-6 bg-gradient-to-r from-amber-900/80 to-orange-900/80 backdrop-blur-sm border border-amber-500/50 rounded-2xl shadow-2xl">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-bold text-amber-200 text-lg mb-2">
                  Artisan Benefits
                </h3>
        ...
        {/* Success Message - Updated with better contrast */}
        {successMessage && (
          <div
            className={`mb-8 p-6 border rounded-2xl backdrop-blur-md shadow-2xl ${
              registrationType === "artisan"
        ...
        {/* Form Card - Made semi-transparent with backdrop blur */}
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-10 border border-white/50">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 bg-white/80 backdrop-blur-sm ${
                      errors.username
              ...
              <div className="mb-10">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all duration-300 bg-white/80 backdrop-blur-sm ${
                        errors.businessName
                          ? "border-red-500 shadow-red-100"
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    <input
                      ...
                      onChange={handleArtisanChange}
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none bg-white/80 backdrop-blur-sm ${
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <input
                        ...
                        onChange={handleArtisanChange}
                        className={`px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none bg-white/80 backdrop-blur-sm ${
                          errors["address.city"]
                            ? "border-red-500 shadow-red-100"
                            : "border-gray-300"
                        }`}
                      ...
                      <input
                        ...
                        onChange={handleArtisanChange}
                        className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none bg-white/80 backdrop-blur-sm"
                        placeholder="State"
                      />
                    </div>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full border transition-all duration-300 ${
                          artisanData.specialization.includes(spec)
                            ...
                            : "bg-white/80 border-gray-300 text-gray-700 hover:border-amber-300 hover:bg-amber-50"
                        }`}
                      >
                        {spec}
                      </button>
                ...
                <div className="mb-6">
                  ...
                  <select
                    ...
                    onChange={handleArtisanChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none bg-white/80 backdrop-blur-sm"
                  >
        ...
        {/* Footer Note - Updated with better contrast */}
