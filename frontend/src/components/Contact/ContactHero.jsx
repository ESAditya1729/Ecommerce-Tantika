      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Have questions about our products, want to collaborate with
            artisans, or need assistance with an order? We're here to help!
          </p>

          {/* Contact Info Cards - FIXED ALIGNMENT */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
            {/* Email Card */}
            {/* Email Card - CLEANER VERSION */}
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow flex flex-col items-center text-center">
              ...
              <div className="mt-2 w-full px-2">
                <a
                  ...
                  className="text-blue-600 font-medium hover:text-blue-700 block truncate"
                  title="tantikacustomercare@outlook.com"
                >
